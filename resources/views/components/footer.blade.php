<footer class="footer">
    ...
    <div class="footer-rights">
        <div class="site-document">
            <span class="small-text">Per visualizzare la documentazione</span>     
            <strong><a href="{{ asset('docs/relazione_progetto.pdf') }}" class="small-text selected-footer"> clicca qui!</a></strong>
        </div>
    </div>
</footer>